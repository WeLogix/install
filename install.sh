...
# you can untar https://mirrors.aliyun.com/homebrew/brew.git/tarball/master
# anywhere you like.
...
REQUIRED_RUBY_VERSION=2.6  # https://mirrors.aliyun.com/homebrew/brew.git/pull/6556
...
# https://mirrors.aliyun.com/homebrew/brew.git/blob/master/Library/Homebrew/keg.rb
...
echo "$(cat <<EOS
  ${tty_underline}https://mirrors.aliyun.com/homebrew/brew.git#donations${tty_reset}
EOS
)
"
